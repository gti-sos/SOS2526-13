...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/14-BZvvahjc.js')),
			__memo(() => import('./chunks/15-BAeUpTtE.js')),
			__memo(() => import('./chunks/16-DqEUqEkd.js')),
			...
			__memo(() => import('./chunks/37-BGsoSr6i.js'))
		],
		remotes: {
