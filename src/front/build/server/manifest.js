...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/14-wYo70rAE.js')),
			__memo(() => import('./chunks/15-BAeUpTtE.js')),
			__memo(() => import('./chunks/16-1ZbkyBCO.js')),
			...
			__memo(() => import('./chunks/21-B3ORlxN8.js')),
			...
			__memo(() => import('./chunks/37-Bw8lkhaM.js'))
		],
		remotes: {
